...
var app = (function () {
    ...
    var easy_qrcode_min = createCommonjsModule(function (module, exports) {
    /**
     * EasyQRCodeJS
     * 
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 48, 0, 1194);
    			add_location(input, file, 50, 0, 1215);
    ...
    function instance($$self, $$props, $$invalidate) {
      ...
      onMount(() => {
        ...
        // logoWidth = 80;
        // logoHeight = 80;
        $$invalidate('colorDark', colorDark = '#275F7A');
        $$invalidate('backgroundImage', backgroundImage =
          'http://www.bigstateelectric.com/wp-content/uploads/2015/05/big-state-electric1.png'); // Background Image
        //backgroundImageAlpha = 1; // Background image transparency, value between 0 and 1. default is 1.
        //autoColor = false;

        qrcode = new easy_qrcode_min(document.getElementById('qrcode'), options);
      });
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('logoWidth' in $$props) $$invalidate('logoWidth', logoWidth = $$props.logoWidth);
    		if ('logoHeight' in $$props) $$invalidate('logoHeight', logoHeight = $$props.logoHeight);
    		if ('colorDark' in $$props) $$invalidate('colorDark', colorDark = $$props.colorDark);
    		if ('backgroundImage' in $$props) $$invalidate('backgroundImage', backgroundImage = $$props.backgroundImage);
    	...
    	$$self.$$.update = ($$dirty = { text: 1, url: 1, logo: 1, logoWidth: 1, logoHeight: 1, colorDark: 1, backgroundImage: 1, options: 1 }) => {
    		if ($$dirty.text) { $$invalidate('url', url = `https://bigstate-safety.appspot.com/${text.replace(' ', '_')}`); }
    		if ($$dirty.url || $$dirty.logo || $$dirty.logoWidth || $$dirty.logoHeight || $$dirty.colorDark || $$dirty.backgroundImage) { $$invalidate('options', options = {
            text: url,
            logo: logo,
            logoWidth: logoWidth,
    		...
    		if ($$dirty.options) { console.log(options); }
    		if ($$dirty.text) { newText(text); }
    	};
